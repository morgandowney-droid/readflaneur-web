...
- **Quarterly refresh:** `refresh-image-library` cron (first Sunday of Mar/Jun/Sep/Dec, 2 AM UTC). Tracks `generation_season` per neighborhood. Emails admin on completion.
