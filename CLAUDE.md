...
- **Truncation:** `truncateAtWord()` helper (120 chars) + CSS `-webkit-line-clamp: 2` for preview text. Satellite sections use `truncateAtSentence()` (160 chars) with same 2-line clamp.
