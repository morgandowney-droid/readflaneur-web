...
export const AD_COLLECTIONS: AdCollection[] = [
  ...
  },
  {
    ...
    dailyPrice: 200,
    sundayPrice: 300,
    description: 'Premium positioning in the world\'s most influential cultural neighborhoods. Your brand connects with tastemakers, and the professionals who shape urban living.',
    exampleNeighborhoods: ['Williamsburg', 'Shoreditch', 'Le Marais', 'Beverly Hills'],
  },
  {
    key: 'tier3',
    name: 'The Discovery Collection',
    tagline: 'Target accelerating hubs in smart global cities.',
    dailyPrice: 100,
    sundayPrice: 150,
    description: 'Strategic reach into neighborhood markets with accelerating wealth density and cultural momentum, from Cape Town\'s Atlantic Seaboard to Dublin\'s Dalkey coast.',
