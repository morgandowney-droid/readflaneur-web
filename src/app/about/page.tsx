    ...
    <div className="py-12 px-4">
      <div className="mx-auto max-w-2xl">
        ...
        <section className="mb-12 pt-8 border-t border-border">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm text-fg-muted">
            <div>
              ...
              <p className="text-fg-subtle">Restaurant openings, chef moves, bar news</p>
            </div>
            <div>
              <p className="font-medium mb-1">Culture</p>
              <p className="text-fg-subtle">Art, music, theater, exhibitions</p>
            </div>
            <div>
              <p className="font-medium mb-1">Retail & Commerce</p>
              <p className="text-fg-subtle">Shop openings, market news, local business</p>
            </div>
            <div>
              <p className="font-medium mb-1">Real Estate</p>
              <p className="text-fg-subtle">Development, property trends, notable sales</p>
            </div>
            <div>
              <p className="font-medium mb-1">Community</p>
              <p className="text-fg-subtle">Local events, neighborhood issues, people</p>
            </div>
            <div>
              <p className="font-medium mb-1">Tonight</p>
              <p className="text-fg-subtle">What&apos;s happening in your neighborhood today</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12 pt-8 border-t border-border">
          ...
          <Link
            href="/contact"
            className="inline-block text-xs tracking-widest uppercase border border-border-strong px-4 py-2 hover:bg-white hover:text-neutral-900 transition-colors"
          >
        ...
        <section className="border-t border-border pt-8">
          ...
          <p className="text-sm text-fg-muted mb-2">
            General inquiries: <a href="mailto:contact@readflaneur.com" className="text-fg underline decoration-neutral-600 hover:text-fg">contact@readflaneur.com</a>
          </p>
          <p className="text-sm text-fg-muted mb-2">
            Advertising: <a href="mailto:ads@readflaneur.com" className="text-fg underline decoration-neutral-600 hover:text-fg">ads@readflaneur.com</a>
          </p>
          <p className="text-sm text-fg-muted">
            Tips: <a href="mailto:tips@readflaneur.com" className="text-fg underline decoration-neutral-600 hover:text-fg">tips@readflaneur.com</a>
          </p>
        </section>
      </div>
    </div>
