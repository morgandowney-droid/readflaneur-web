      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between gap-4">
            <div>
              <div className="h-3 w-16 bg-neutral-800 rounded mb-1" />
        ...
        <div className="mb-6 space-y-3">
          <div className="flex gap-1.5">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="h-6 w-16 bg-neutral-800 rounded" />
            ))}
          </div>
          <div className="flex gap-1.5">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="h-8 w-20 bg-neutral-800 rounded" />
            ))}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="border border-white/[0.08] bg-surface overflow-hidden">
