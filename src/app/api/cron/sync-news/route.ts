        ...
        try {
          ...
          const { data: insertedArticle, error: insertError } = await supabase
            ...
            .insert({
              ...
              image_url: selectLibraryImage(neighborhoodId, 'standard', undefined, libraryReadyIds, results.articles_created),
              status: 'published',
        ...
        for (const story of stories) {
          ...
          const { data: insertedArticle, error: insertError } = await supabase
            ...
            .insert({
              ...
              image_url: selectLibraryImage(hood.id, 'standard', undefined, libraryReadyIds, results.grok_articles_created),
              status: 'published',
              published_at: new Date().toISOString(),
              created_at: new Date().toISOString(),
              updated_at: new Date().toISOString(),
