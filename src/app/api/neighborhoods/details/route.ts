...
/**
 * @swagger
 * /api/neighborhoods/details:
 *   get:
 *     summary: Get neighborhood details by IDs
 *     description: Returns neighborhood names, cities, and thumbnail images for a list of neighborhood IDs. No auth required. 5-minute cache.
 *     tags:
 *       - Neighborhoods
 *     parameters:
 *       - in: query
