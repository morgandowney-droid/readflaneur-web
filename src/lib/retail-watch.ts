...
export const LUXURY_BRANDS: LuxuryBrand[] = [
  ...
  { name: 'Aimé Leon Dore', pattern: /aim[eé]\s*leon\s*dore/i, category: 'Fashion', tier: 'Aspirational' },
  ...
  { name: 'Creed', pattern: /\bcreed\s*(boutique|fragrance|parfum)\b|house\s*of\s*creed/i, category: 'Beauty & Fragrance', tier: 'Ultra' },
  ...
  { name: 'Credo Beauty', pattern: /credo\s*beauty/i, category: 'Beauty & Fragrance', tier: 'Aspirational' },
  ...
  { name: 'Rumble', pattern: /\brumble\s*(boxing|fitness|gym)\b/i, category: 'Fitness & Wellness', tier: 'Aspirational' },
  ...
  { name: 'Aman', pattern: /\baman\s*(resort|hotel|new\s*york)\b/i, category: 'Hospitality', tier: 'Ultra' },
  ...
  { name: 'Edition', pattern: /\bedition\s*(hotel|residences)\b/i, category: 'Hospitality', tier: 'Aspirational' },
  { name: 'Pendry', pattern: /pendry/i, category: 'Hospitality', tier: 'Aspirational' },

  // ─────────────────────────────────────────────────────────────
  // HOME & DESIGN
  // ─────────────────────────────────────────────────────────────
  { name: 'RH (Restoration Hardware)', pattern: /restoration\s*hardware|\brh\s*(gallery|store|showroom)\b/i, category: 'Home & Design', tier: 'Aspirational' },
  ...
  { name: 'COS', pattern: /\bcos\s*(store|stores)\b/i, category: 'Fashion', tier: 'Aspirational' },
  ...
  { name: 'Apple', pattern: /\bapple\s*(store|retail|inc)\b/i, category: 'Home & Design', tier: 'Aspirational' },
  ...
  { name: 'Vince', pattern: /\bvince\s*(store|shop|boutique)\b/i, category: 'Fashion', tier: 'Aspirational' },
  { name: 'Theory', pattern: /\btheory\s*(store|shop|boutique)\b/i, category: 'Fashion', tier: 'Aspirational' },
  ...
  { name: 'Sandro', pattern: /\bsandro\s*(paris|store|boutique)\b/i, category: 'Fashion', tier: 'Aspirational' },
